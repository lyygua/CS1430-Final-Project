...
class TEST(MIFGSM):
    ...
    def transform(self, x, **kwargs):
        ...
        x_amplitude_perturbed = x_amplitude + torch.randn_like(x_amplitude) * 0.4
        x_phase_perturbed = x_phase + torch.rand_like(x_phase)
        ...
        x_idct = self.idct_2d(x_dct_perturbed_real)
